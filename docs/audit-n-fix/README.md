...
> [!CAUTION]
>
> Intended for use on headless Linux servers—may break some home desktops.
...
> [!NOTE]
>
> More dependencies may be specified, nested deeper down for specific scripts.

- [`bash-lib`](/docs?q=bash-lib/README) (Latest)